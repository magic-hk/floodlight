...
public class Link implements Comparable<Link> {
    ...
    public Link(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 latency) {
        ...
        this.weight = TopologyInstance.MAX_LINK_WEIGHT;
    }
    
    public Link(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 latency,Integer weight){
        this.src = srcId;
        this.srcPort = srcPort;
        this.dst = dstId;
        this.dstPort = dstPort;
