...
public class LinkBak implements Comparable<LinkBak> {
    ...
    public LinkBak(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 latency) {
        this.src = srcId;
    ...
    @Override
    public int compareTo(LinkBak a) {
