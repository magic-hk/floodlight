...
import net.floodlightcontroller.linkdiscovery.ILinkDiscoveryServiceBak;
 ...
 */
public class LinkDiscoveryManagerBak implements IOFMessageListener,
IOFSwitchListener, IStorageSourceListener, ILinkDiscoveryServiceBak,
IFloodlightModule, IInfoProvider {
	protected static final Logger log = LoggerFactory.getLogger(LinkDiscoveryManagerBak.class);
	...
	private final String PACKAGE = LinkDiscoveryManagerBak.class.getPackage().getName();
	...
	private class HAListenerDelegate implements IHAListener {
		...
		public void transitionToActive() {
			...
			LinkDiscoveryManagerBak.this.role = HARole.ACTIVE;
			clearAllLinks();
			readTopologyConfigFromStorage();
		...
		public void transitionToStandby() {
            ...
            LinkDiscoveryManagerBak.this.role = HARole.STANDBY;
		}
	}
